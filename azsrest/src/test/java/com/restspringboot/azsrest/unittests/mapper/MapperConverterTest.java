...
public class MapperConverterTest {
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = DozerMapper.parseObjectList(inputObject.mockEntityList(), PersonVO.class);
    ...
    public void parserVOListToEntityListTest() {
        List<Person> outputList = DozerMapper.parseObjectList(inputObject.mockVOList(), Person.class);
